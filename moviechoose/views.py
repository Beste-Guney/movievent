...
# class MovieRecommendFriend(View):
#     def get(self, request):
#         form = FriendForm(user=request.user)
#         owner = request.user
#         return render(request, 'recommendation_page.html', {'form': form, 'user': owner, 'posted': False})
#
#     def post(self, request):
#         form = FriendForm(request.POST, user=request.user)
#         if form.is_valid():
...
#         friend = form.cleaned_data['friends']
#
#         # cluster_of_user = k_means_movie(request.user)[1]
#         # cluster_of_friend = k_means_movie(friend)[1]
#         # labels_of_friend = k_means_movie(friend)[2]
#         # labels_of_yourself = k_means_movie(request.user)[2]
#         # recommended_movies = get_distance_between_clusters(cluster_of_user, cluster_of_friend, labels_of_friend, 3)
#         k_means_my_implementation(request.user)
#
#     #     for i in labels_of_yourself[0]:
#     #         mov = Movie.objects.get(id=i)
#     #         your_category_1.append(mov)
#     #
#     #     for i in labels_of_yourself[1]:
#     #         mov = Movie.objects.get(id=i)
#     #         your_category_2.append(mov)
#     #
#     #     for i in labels_of_yourself[2]:
#     #         mov = Movie.objects.get(id=i)
#     #         your_category_3.append(mov)
#     #
#     #     for i in recommended_movies[0]:
#     #         mov = Movie.objects.get(id=i)
#     #         if mov not in your_category_1:
#     #             category_1.append(mov)
#     #
#     #     for i in recommended_movies[1]:
#     #         mov = Movie.objects.get(id=i)
#     #         if mov not in your_category_2:
#     #             category_2.append(mov)
#     #
#     #     for i in recommended_movies[2]:
#     #         mov = Movie.objects.get(id=i)
#     #         if mov not in your_category_3:
#     #             category_3.append(mov)
#     #
#     # context = {'category_1': category_1, 'category_2': category_2,  'category_3': category_3, 'posted': True,
#     #            'your_1': your_category_1, 'your_2': your_category_2, 'your_3': your_category_3, 'friend': friend
#     #            }
#     #return render(request, 're_results.html', context)
